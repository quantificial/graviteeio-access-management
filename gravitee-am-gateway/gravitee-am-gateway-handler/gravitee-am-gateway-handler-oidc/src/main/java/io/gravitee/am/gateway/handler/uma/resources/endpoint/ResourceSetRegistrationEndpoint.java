...
import io.gravitee.am.gateway.handler.uma.resources.request.ResourceSetRequestResponse;
        ...
        this.extractRequest(context)
                ...
                .subscribe(
                        resourceSet -> context.response()
                                ...
                                .end(Json.encodePrettily(ResourceSetRequestResponse.from(resourceSet)))
                        , error -> context.fail(error)
                );
    }
