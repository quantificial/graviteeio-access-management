...
import io.gravitee.am.gateway.handler.uma.exception.ResourceSetRegistrationForbiddenException;
 ...
 */
public class ResourceSetRegistrationAccessHandler implements Handler<RoutingContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ResourceSetRegistrationAccessHandler.class);
    private Domain domain;
    private OAuth2AuthHandler oAuth2AuthHandler;

    public ResourceSetRegistrationAccessHandler(Domain domain, OAuth2AuthHandler oAuth2AuthHandler) {
        this.domain = domain;
