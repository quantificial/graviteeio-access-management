...
public class ResourceSetRegistrationAccessHandlerTest {
    ...
    @InjectMocks
    private ResourceSetRegistrationAccessHandler handler = new ResourceSetRegistrationAccessHandler(domain, oAuth2AuthHandler);
    ...
    public void testWhenUmaNotYetSetOnDomain() {
        ...
        Assert.assertTrue("Should return a forbidden exception", exceptionCaptor.getValue() instanceof ResourceSetRegistrationForbiddenException);
    }
