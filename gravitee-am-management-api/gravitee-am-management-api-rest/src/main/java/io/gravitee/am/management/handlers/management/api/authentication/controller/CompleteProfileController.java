...
public class CompleteProfileController {
    ...
    public ModelAndView showForm(Authentication authentication) {
        ...
        return new ModelAndView(Template.COMPLETE_PROFILE.template(), Collections.singletonMap("user", endUser));
    }
    ...
    private void subscribeNewsletter(User endUser) {
        ...
        object.put("firstname", endUser.getFirstName());
        object.put("lastname", endUser.getLastName());
